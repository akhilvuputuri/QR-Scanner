      ...
      <View style={{ flex: 1 }}>
        <ScrollView>
          <View style={styles.cardsContainer}>
            ...
            <View style={{alignItems: 'center', justifyContent: 'center', paddingTop: 180}}>
            <Image 
              ...
              />
              <Text style={{fontSize: 14, fontFamily: 'OpenSans_700Bold', color: '#fff'}}>You currently have no vouchers.</Text>
              <Text style={{fontSize: 14, fontFamily: 'OpenSans_700Bold', color: '#fff'}}>Shop Now!</Text>
            </View>
          </View>
        </ScrollView>
      </View>
